...
public class GlycoTraverserTreeProstOrder extends GlycoTraverser
{
    public GlycoTraverserTreeProstOrder(GlycoVisitor a_objVisitor) throws GlycoVisitorException
    {
        super(a_objVisitor);
    }
    ...
    {
        // traverse subtree
        for (Iterator<GlycoEdge> t_iterLinkages = a_objResidue.getChildEdges()
                .iterator(); t_iterLinkages.hasNext();)
        {
